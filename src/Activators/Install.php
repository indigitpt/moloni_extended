...
class Install
{
    ...
    private static function insertSettings()
    {
        ...
        // custom
        $wpdb->query("INSERT INTO `moloni_api_config`(config, description) VALUES('document_type_by_payment', 'Tipo de documento baseado no pagamento')");
        $wpdb->query("INSERT INTO `moloni_api_config`(config, description) VALUES('email_send_internal', 'Lista de emails a enviar a factura internalmente (separados por virgula \",\")')");
    }
